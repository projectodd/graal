...
public class AArch64PatchingAnnotation extends PatchingAnnotation {
    private final OperandDataAnnotation annotation;

    public AArch64PatchingAnnotation(int instructionStartPosition, OperandDataAnnotation annotation) {
